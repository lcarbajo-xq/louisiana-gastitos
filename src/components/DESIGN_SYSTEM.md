...
;<View className='flex-1 bg-gray-900 p-4'>
  <StatusBadge status='success' text='Presupuesto OK' className='mb-4' />

  <ProgressBar progress={67} label='Gasto Mensual' className='mb-6' />

  <CategoryLegend categories={categories} variant='compact' className='mb-4' />
