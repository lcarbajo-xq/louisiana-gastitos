    ...
    <View className={`w-full ${className}`}>
      {(showLabel || label) && (
        <View className='flex-row justify-between items-center mb-2'>
          <Text
            className={`${variantStyles.text} ${sizeStyles.text} font-medium`}>
            {label || `Progreso`}
          </Text>
          <Text
            className={`${variantStyles.text} ${sizeStyles.text} font-bold`}>
      ...
      <View
        className={`w-full ${sizeStyles.height} ${variantStyles.track} rounded-full overflow-hidden`}>
        <View
          className={`${sizeStyles.height} ${variantStyles.fill} rounded-full ${
